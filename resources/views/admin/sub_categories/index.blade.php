	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-header">
				<div class="pull-left">
					<h4>Sub Categories of {{ $parentCategory -> name }}</h4>
				</div>
				<div class="pull-right">
					<a class="btn btn-primary" href="{{ route('admin.sub-category.create', $parentCategory -> id) }}"><i class="fa fa-plus"></i> New</a>
				</div>
			</div>
			<div class="card-body">
				...
				<table class="table">
					...
					<tbody>
						...
						<tr>
							...
							<td>{{ $category -> name }}</td>
							<td>
								<a href="{{ route('admin.sub-projects.index', $category -> id) }}" class="btn btn-info" style="padding:10 20px;"><i class="fa fa-eye"></i><br>View Projects</a>
							</td>
							<td>
								<a href="{{ route('admin.sub-categories.edit', [ $category -> id ]) }}" class="btn btn-primary btn-sm pull-left m-r-5 waves waves-effect" title="Edit"><i class="fa fa-wrench" title="Edit"></i></a>
								...
								{!! Form::open(['route' => ['admin.sub-categories.destroy', $category -> id], 'method' => 'DELETE', 'id' => $category -> id]) !!}
