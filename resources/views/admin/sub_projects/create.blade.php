			...
			<div class="card-body">
					...
					<div class="row">
						<div class="col-md-12 col-lg-12">
							...
							<div class="pull-right">
								<a class="btn btn-primary" href="{{ route('admin.sub-projects.index', $parentCategory -> id) }}"> Back</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-12 col-lg-12">
						...
						{!! Form::open(array('route' => ['admin.sub-projects.store', $parentCategory -> id],'method'=>'POST', 'files' => true)) !!}
