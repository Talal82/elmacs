...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-lg-12">
		<div class="card">
			...
			<div class="card-body">
				{!! Form::open(array('route' => 'admin.teams.store','method'=>'POST', 'files' => true)) !!}
				<div class="row">
					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
						<div class="form-group">
							...
							<input type="file" name="image" id="image" class="dropify form-control-file" data-height="295">
						</div>
					</div>					
					
					<div class="col-xs-12 col-sm-12 col-md-12">
						<button type="submit" class="btn btn-primary btn-block">Create New Member</button>
					</div>
				</div>
				{!! Form::close() !!}
			</div>
