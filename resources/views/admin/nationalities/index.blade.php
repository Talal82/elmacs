	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-header">
				<div class="pull-left">
					<h4>All Nationalities</h4>
				</div>
				<div class="pull-right">
					<a class="btn btn-primary" href="{{ route('admin.nationality.create') }}"><i class="fa fa-plus"></i> New</a>
				</div>
			</div>
			<div class="card-body">
				...
				<table class="table">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<a href="{{ route('admin.nationality.edit', [ $nationality -> id ]) }}" class="btn btn-primary btn-sm pull-left m-r-5 waves waves-effect" title="Edit"><i class="fa fa-wrench" title="Edit"></i></a>

								<a href="javascript:void(0);" data-id="{{ $nationality-> id }}" class="sa-remove waves wave-effect btn btn-danger btn-sm pull-left" title="Delete"><i class="fa fa-trash"></i></a>
								

								{!! Form::open(['route' => ['admin.nationality.destroy', $nationality -> id], 'method' => 'DELETE', 'id' => $nationality -> id]) !!}
