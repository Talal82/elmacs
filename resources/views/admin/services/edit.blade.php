					...
					<div class="col-md-12 col-lg-12">
						...
						<div class="tab-content">
									...
									<div class="row">
										...
										<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
											<div class="form-group m-t-30 checkbox checkbox-primary">
												<input type="checkbox" id="featured" name="featured" {{ ($service -> featured == true) ? 'checked' : '' }}>
							...
							<div role="tabpanel" class="tab-pane fade " id="set2">
								<h4>Image</h4>
								<input type="file" name="main_image" id="main_image" class="dropify form-control-file" data-height="300" data-default-file="{{ asset('public/uploads/images/services/'.$service -> main_image ) }}">
							</div>
						</div>
					</div>
				</div>
